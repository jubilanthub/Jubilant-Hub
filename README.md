...
<!-- TOTAL PRICE -->
<div id="totalPrice" style="margin-top:10px;">
Total: R0
</div>
...
<!-- WHATSAPP ORDER BUTTON (SEPARATE BOX) -->
<div id="orderBox">
...
<!-- CAPITEC PAY BUTTON (SEPARATE BOX) -->
<div id="payBox" style="
position:fixed;
right:10px;
bottom:210px;
...
<button class="cart-btn" onclick="capitecPay()">
Pay via Capitec
</button>
